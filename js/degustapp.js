...
//var mapcoor = new google.maps.LatLng(+data[i].COORDENADAX+, +data[i].COORDENADAY+);
     ...
     $("#lista").listview("refresh");
      ...
      $("#lista").on("click", "div a", function(e){
        ...
        $("#Detalles").append("<div class=\"perfil\"><br>PUNTAJE:<input type=\"hidden\" id=\"pactual\" value="+ obj.PUNTAJE +"><i id=\"puntajeactual\">" + obj.PUNTAJE +"</i><i id=\"ptotal\"></i> IDGRUPO:<b>" + obj.IDGRUPO +"</b></div>");
